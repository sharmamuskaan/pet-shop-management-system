...
<form method="post">
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;margin-top:5px;width:95%;height:40px;line-height:40px;background:#D85587;color:#fff;text-align:center;margin-left:20px;padding-left:10px;border-radius:4px;border:1px solid aquamrine;"><?php echo"".$row['pet_name']."";?></h1>
		<div id="pet1">
			<ul>
		...
		<li style="margin-left:20px;margin-top:20px;">Quantity:  <?php echo"".$row['pet_quantity']."";?></li>
		...
		$query->execute();
		echo"<div id='pet'>
		<h1 style='text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:20px;width:92%;background:#D85587;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>Relative Pets</h1>";
...
<h1 style="text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:28%;width:92%;background:#D85587;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;">Feedbacks</h1>

...
#header input[type=submit]{
	margin-left:610px;margin-top:-280px;width:70px;height:40px;border-radius:4px;border:1px solid #D85587;background:#fff;color:#425298;
} 
</style>
</head>
<body>
...
include("header_index.php");
		...
		$query->execute();
		echo"<div id='pet'>
<h1 style='text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;padding-left:10px;margin-left:60px;margin-top:20px;width:92%;background:#D85587;color:#fff;text-align:left;height:40px;line-height:40px;font-size:23px;border-radius:4px;'>Search keyword like '".$_GET['keyword']."'</h1>";

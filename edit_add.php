		...
		if(isset($_COOKIE['usernameget']))
				{
					...
					echo"<div id='showadd'>
						<h1 style='width:100%;height:40px;line-height:40px;background:#D85587;color:#fff;text-align:center;margin-top:20px;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;'>Edit to this Address</h1>

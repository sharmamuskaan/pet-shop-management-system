...
<head>
<style>
#show{width:90%;height:400px;background:#fff;margin-left:100px;border-radius:4px;box-shadow: 3px 3px 3px #000;border-radius:4px;border:2px solid #D85587;margin-top:20px;}
...
?>	<div id="show">
<h1 style="width:100%;height:40px;line-height:40px;background:#D85587;color:#fff;text-align:center;margin-top:20px;border-radius:4px;text-shadow: 5px 5px 5px #000;box-shadow: 3px 3px 3px #000;">Select payment Method</h1>

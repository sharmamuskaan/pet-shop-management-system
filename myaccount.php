...
<style>
body{background:#;}
#box1{border:1px ;padding-left:200px;}
...
<body>
<a href="index.php" style="color:B39BC8;font-size:20px;">Home Page</a>
<?php
	...
	echo"<h1 style='color:WHITE;background:#D85587;text-align:center;line-height:50px;height:50px;'>Your Address</h1>";
		echo"<div id='box1'>";
...
?>
					<div id="show">
						<h1 style="color:#fff;background:#D83587;text-align:center;line-height:50px;height:50px;">Your orders</h1>
